            ...
            <div class="flex items-center">
              ...
              >
                <option
                  :value="limit.value"
                  :selected="
                    ptjStore.filter.currentLimit == limit.value ? true : false
                  "
                ...
                <td class="px-4 py-1">
                  <ul class="list-disc">
                    <li
                      ...
                      v-for="(lampiran, index) in item.lampiran"
                      :key="index"
                    >
                      <a
                        :href="`${storageUrl + '/' + lampiran.lampiran}`"
        ...
        >
          <span class="text-sm font-normal text-gray-500 dark:text-gray-400">
            ...
            <span class="font-semibold text-gray-900 dark:text-white"
              >{{ ptjStore.from }} - {{ ptjStore.to }}</span
            >
            of
            <span class="font-semibold text-gray-900 dark:text-white">{{
              ptjStore.total
          ...
          <ul class="inline-flex items-stretch -space-x-px">
            ...
            <li>
              <a
                @click="
                  ptjStore.lastPage == ptjStore.currentPage ? '' : nextPage()
                "
                :class="
