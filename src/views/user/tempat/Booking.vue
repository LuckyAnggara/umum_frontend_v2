  ...
  <div class="max-w-xl mx-auto px-6 py-8 md:max-w-lg">
    ...
    <form @submit.prevent="confirm()" class="mt-4 bg-white rounded-lg border border-gray-400 max-h-full overflow-visible">
      ...
      <div class="flex items-center justify-between p-3 bg-gray-100">
        <span v-if="tempatStore.items.length > 0" class="p-4 mb-4 text-sm text-red-800 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400">
          Pastikan kembali jadwal kegiatan tidak berbenturan dengan kegiatan lainnya
        </span>
