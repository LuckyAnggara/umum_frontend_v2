        ...
        <div class="w-full flex flex-row space-x-3 items-center">
          <div class="flex items-center">
            ...
            >
              <option
                :value="limit.value"
                :selected="
                  sbmStore.filter.currentLimit == limit.value ? true : false
                "
          ...
          <div class="flex items-center">
            ...
            >
              <option
                :value="value"
                :selected="sbmStore.filter.tahun == value ? true : false"
                v-for="(value, index) in mainStore.tahunOptions"
                :key="index"
              >
                {{ value }}
              </option>
      ...
      >
        <span class="text-sm font-normal text-gray-500 dark:text-gray-400">
          ...
          <span class="font-semibold text-gray-900 dark:text-white"
            >{{ sbmStore.from }} - {{ sbmStore.to }}</span
          >
          of
          <span class="font-semibold text-gray-900 dark:text-white">{{
            sbmStore.total
        ...
        <ul class="inline-flex items-stretch -space-x-px">
          ...
          <li>
            <a
              @click="
                sbmStore.lastPage == sbmStore.currentPage ? '' : nextPage()
              "
              :class="
