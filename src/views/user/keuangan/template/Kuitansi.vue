        ...
        <div class="print-area mx-auto bg-white p-8 max-w-3xl">
          ...
          <div class="mb-3 border p-2 text-left text-xs">
            ...
            <div class="mb-1 flex">
              ...
              <p class="ml-1 w-8/12">{{ terbilang(perjadinDetailStore.totalDetailBiaya) }} Rupiah</p>
            </div>
            <div class="mb-1 flex">
              <p class="flex w-4/12 flex-row justify-between font-semibold"><span>Berdasarkan SPPD Nomor</span><span>:</span></p>
              <p class="ml-1 w-8/12">ITJ.1-KU.03.02-{{ perjadinDetailStore.singleResponse.no_sppd }}</p>
            </div>
            <div class="mb-1 flex">
          ...
          <div class="mb-3 border p-2 text-left text-xs">
            ...
            <div class="flex flex-col space-y-1">
              <div class="mb-1 flex">
                ...
                <ul class="list-disc ml-1 w-8/12">
                  <li class="flex flex-row w-full justify-between" v-for="(item, index) in perjadinDetailStore.singleResponse.hotel" :key="index">
                    <div class="">
                      <span v-if="perjadinDetailStore.singleResponse.hotel.length > 1">•</span>
              ...
              <div class="mb-1 flex">
                ...
                <ul class="list-disc ml-1 w-8/12">
                  <li class="flex flex-row w-full justify-between" v-for="(item, index) in perjadinDetailStore.singleResponse.uang_harian" :key="index">
                    <div class="">
                      <span v-if="perjadinDetailStore.singleResponse.uang_harian.length > 1">•</span>
                      <span class="text-gray-900">{{ item.hari }} Hari x </span>
                      <span> {{ IDRCurrency.format(item.biaya) }}</span>
                    </div>
                    <div class="ml-1 flex flex-row justify-between">
              ...
              <div class="mb-1 flex">
                ...
                <ul class="list-disc ml-1 w-8/12">
                  <li class="flex flex-row w-full justify-between" v-for="(item, index) in perjadinDetailStore.singleResponse.pesawat" :key="index">
                    <div class="">
                      <span v-if="perjadinDetailStore.singleResponse.pesawat.length > 1">•</span>
              ...
              <div class="mb-1 flex">
                ...
                <ul class="list-disc ml-1 w-8/12">
                  <li class="flex flex-row w-full justify-between" v-for="(item, index) in perjadinDetailStore.singleResponse.transport" :key="index">
                    <div class="">
                      <span v-if="perjadinDetailStore.singleResponse.transport.length > 1">•</span>
              ...
              <div class="mb-1 flex">
                ...
                <ul class="list-disc ml-1 w-8/12">
                  <li class="flex flex-row w-full justify-between" v-for="(item, index) in perjadinDetailStore.singleResponse.taksi_jakarta" :key="index">
                    <div class="">
                      <span v-if="perjadinDetailStore.singleResponse.taksi_jakarta.length > 1">•</span>
                      <span> {{ item.keterangan }}</span>
                    </div>
                    <div class="ml-1 flex flex-row justify-between">
                      <span class="text-gray-900 w-32 text-right font-semibold"> {{ IDRCurrency.format(item.biaya) }}</span>
              ...
              <div class="mb-1 flex">
                ...
                <ul class="list-disc ml-1 w-8/12">
                  <li class="flex flex-row w-full justify-between" v-for="(item, index) in perjadinDetailStore.singleResponse.taksi_tujuan" :key="index">
                    <div class="">
                      <span v-if="perjadinDetailStore.singleResponse.taksi_tujuan.length > 1">•</span>
                      <span> {{ item.keterangan }}</span>
                    </div>
                    <div class="ml-1 flex flex-row justify-between">
                      <span class="text-gray-900 w-32 text-right font-semibold"> {{ IDRCurrency.format(item.biaya) }}</span>
              ...
              <div class="mb-1 flex">
                ...
                <ul class="list-disc ml-1 w-8/12">
                  <li class="flex flex-row w-full justify-between" v-for="(item, index) in perjadinDetailStore.singleResponse.representatif" :key="index">
                    <div class="">
                      <span v-if="perjadinDetailStore.singleResponse.representatif.length > 1">•</span>
                      <span class="text-gray-900">{{ item.hari }} Hari x </span>
                      <span> {{ IDRCurrency.format(item.biaya) }}</span>
                    </div>
                    <div class="ml-1 flex flex-row justify-between">
            ...
            <div class="my-2 flex">
              ...
              <p class="w-8/12 border-t pb-2 font-bold text-right">
                <span> {{ IDRCurrency.format(perjadinDetailStore.totalDetailBiaya) }}</span>
              </p>
            </div>
            <div>
          ...
          <div class="mb-3 border p-2 text-left text-xs">
            <div class="grid grid-cols-3 gap-4 text-center">
              ...
              <div class="text-center">
                <p>
                  Jakarta, <span class="invisible">{{ perjadinDetailStore.singleResponse.master.tanggal_st }}</span>
                </p>
              </div>
            </div>
