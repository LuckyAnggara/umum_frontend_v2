<template>
  <div class="text-left w-full">
    <h2 class="text-2xl mb-4">Taksi Tujuan</h2>
    ...
    <div class="flex flex-col space-y-2">
      <div>
        ...
        <select
          v-model="perjadinStore.newPegawai.nominatif_taksi_tujuan"
          ...
          :value="
            IDRCurrency.format(
              perjadinStore.totalSisaPaguNominatif(
                perjadinStore.newPegawai.nominatif_taksi_tujuan
              )
            )
          "
          required
      ...
      <div class="grid grid-cols-2 gap-4">
        <div class="text-left">
          ...
          <input
            ...
            v-model="perjadinStore.newTaksiTujuan.keterangan"
            required
            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
          />
        </div>
        <div class="text-left">
          ...
          <input
            type="number"
            v-model="perjadinStore.newTaksiTujuan.biaya"
            required
            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
          />
        </div>
      ...
      <div class="flex items-center space-x-4 my-4">
        <button
          @click="perjadinStore.tambahTaksiTujuan"
          type="submit"
      ...
      >
        ...
        >
          ...
          <tbody>
            <tr v-if="perjadinStore.newPegawai.taksi_tujuan < 1">
              <td colspan="4" class="text-center">Tidak ada data</td>
            </tr>
            <tr
              v-else
              v-for="(item, index) in perjadinStore.newPegawai.taksi_tujuan"
              :key="index"
            ...
            >
              ...
              <td class="px-4 py-1">
                <div @click="perjadinStore.deleteTaksiTujuan(index)">
      ...
      <div class="flex flex-row justify-start space-x-4">
        <div class="text-left w-32 mt-4">
          ...
          <input
            readonly
            :value="IDRCurrency.format(perjadinStore.getTotalTaksiTujuan)"
            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
          />
        </div>
      </div>
