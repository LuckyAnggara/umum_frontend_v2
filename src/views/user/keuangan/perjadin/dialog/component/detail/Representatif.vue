  ...
  <div class="text-left w-full">
    ...
    <div class="flex flex-col space-y-2">
      <div>
        ...
        <select
          v-model="perjadinStore.newPegawai.nominatif_representatif"
          ...
          :value="
            IDRCurrency.format(
              perjadinStore.totalSisaPaguNominatif(
                perjadinStore.newPegawai.nominatif_representatif
              )
            )
          "
          required
      ...
      <div class="grid grid-cols-3 gap-4">
        ...
        <div class="text-left">
          ...
          <input
            ...
            :value="
              IDRCurrency.format(
                perjadinStore.newRepresentatif.hari *
                  perjadinStore.newRepresentatif.biaya
              )
            "
            required
            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
