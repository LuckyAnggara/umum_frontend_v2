<template>
  <div class="text-left w-full">
    <h2 class="text-2xl mb-4">taksi_tujuan</h2>
    <div v-show="!disabledForm" class="flex items-center space-x-4 my-4">
      <button
        @click="perjadinDetailStore.tambahTaksiTujuan"
        type="submit"
        ...
        >
          ...
          >
            <tr>
              ...
              <th scope="col" class="px-4 py-3 w-4/12">Keterangan</th>
          ...
          <tbody>
            <tr v-if="perjadinDetailStore.singleResponse.taksi_tujuan < 1">
            ...
            >
              ...
              <td class="py-1">
                <div
                  v-show="!disabledForm"
                  @click="perjadinDetailStore.deleteTaksiTujuan(index)"
          ...
          <tfoot>
            ...
            <td class="px-4 py-1 font-bold">
              {{
                IDRCurrency.format(perjadinDetailStore.getTotal.taksi_tujuan)
              }}
            </td>
            <td class="px-4 py-1 font-bold">
              {{
                IDRCurrency.format(
                  perjadinDetailStore.getTotal.taksi_tujuan_real
                )
              }}
            </td>
            <td class="px-4 py-1 font-bold">
              ...
              {{
                IDRCurrency.format(
                  perjadinDetailStore.getTotal.taksi_tujuan -
                    perjadinDetailStore.getTotal.taksi_tujuan_real
                )
              }}
            </td>
