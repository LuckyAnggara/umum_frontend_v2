<template>
  <div class="text-left w-full">
    ...
    <div v-show="!disabledForm" class="flex items-center space-x-4 my-4">
      <button
        @click="perjadinDetailStore.tambahPesawat"
        type="submit"
    ...
    <div class="flex flex-col space-y-8">
      ...
      >
        ...
        >
          ...
          <tbody>
            <tr v-if="perjadinDetailStore.singleResponse.pesawat < 1">
            ...
            >
              ...
              <td class="py-1">
                <div
                  v-show="!disabledForm"
                  @click="perjadinDetailStore.deletePesawat(index)"
          ...
          <tfoot>
            ...
            <td class="px-4 py-1 font-bold">
              {{ IDRCurrency.format(perjadinDetailStore.getTotal.pesawat) }}
            </td>
            <td class="px-4 py-1 font-bold">
              {{
                IDRCurrency.format(perjadinDetailStore.getTotal.pesawat_real)
              }}
            </td>
            <td class="px-4 py-1 font-bold">
              Lebih / Kurang :
              {{
                IDRCurrency.format(
                  perjadinDetailStore.getTotal.pesawat -
                    perjadinDetailStore.getTotal.pesawat_real
                )
              }}
            </td>
          </tfoot>
