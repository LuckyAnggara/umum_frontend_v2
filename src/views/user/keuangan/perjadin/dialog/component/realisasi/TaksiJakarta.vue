<template>
  <div class="text-left w-full">
    ...
    <div v-show="!disabledForm" class="flex items-center space-x-4 my-4">
      <button
        @click="perjadinDetailStore.tambahTaksiJakarta"
        type="submit"
    ...
    <div class="flex flex-col space-y-8">
      ...
      >
        ...
        >
          ...
          <tbody>
            <tr v-if="perjadinDetailStore.singleResponse.taksi_jakarta < 1">
            ...
            >
              ...
              <td class="py-1">
                <div
                  v-show="!disabledForm"
                  @click="perjadinDetailStore.deleteTaksiJakart(index)"
          ...
          <tfoot>
            ...
            <td class="px-4 py-1 font-bold">
              {{
                IDRCurrency.format(perjadinDetailStore.getTotal.taksi_jakarta)
              }}
            </td>
            <td class="px-4 py-1 font-bold">
              {{
                IDRCurrency.format(
                  perjadinDetailStore.getTotal.taksi_jakarta_real
                )
              }}
            </td>
            <td class="px-4 py-1 font-bold">
              ...
              {{
                IDRCurrency.format(
                  perjadinDetailStore.getTotal.taksi_jakarta -
                    perjadinDetailStore.getTotal.taksi_jakarta_real
                )
              }}
            </td>
...
function fileChange(event) {
  ...
  perjadinDetailStore.$patch((state) => {
    state.lampiran.taksi_jakarta = b
  })
}
</script>
