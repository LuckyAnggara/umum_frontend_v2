<template>
  ...
  >
    <h5 id="drawer-navigation-label" class="text-base font-semibold text-gray-500 uppercase dark:text-gray-400">Log Status</h5>
    <button
      @click="emit('close')"
      type="button"
    ...
    <div class="py-4 overflow-y-auto px-6">
      <ol class="relative border-s border-gray-200 dark:border-gray-700">
        <li class="mb-10 ms-4" v-for="(item, index) in perjadinStore.singleResponse.log" :key="index">
          ...
          <small class="font-normal text-gray-500 text-xs">
            created by :
