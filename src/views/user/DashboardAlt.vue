<template>
  <div class="sm:mx-auto sm:w-full lg:w-1/3 xl:w-1/5 md:w-1/2 overflow-y-scroll space-y-3 border-8 rounded-3xl bg-white shadow-2xl z-10">
    <div
    ...
    >
          ...
          <div class="flex justify-end items-center relative">
            <div class="inline relative">
              <div class="block flex-grow-0 flex-shrink-0">
                <img
                  class="rounded-xl w-8 h-8 border border-yellow-300 shadow"
      ...
      <div class="px-3 rounded-lg flex flex-col w-full">
        <h4 class="text-white text-xl font-semibold leading-tight truncate">Loremipsum Title</h4>
      ...
      <div class="flex items-center justify-between mt-3 px-3 z-10">
        <div class="relative w-full">
          <input type="text" class="bg-purple-white shadow rounded-xl border-0 p-3 w-full" placeholder="Search somthing..." />
    ...
    <div class="p-3 space-y-4 z-0">
      ...
      <div class="grid m-0 grid-cols-2 space-x-4 overflow-y-scroll flex justify-center items-center w-full">
        <div
          class="relative flex flex-col justify-between bg-white shadow-md rounded-3xl bg-cover text-gray-800 overflow-hidden cursor-pointer w-full object-cover object-center rounded-lg shadow-md h-64 my-2"
          style="
        ...
        >
          ...
          <div class="relative flex flex-row items-end h-72 w-full">
            ...
            <div class="p-6 rounded-lg flex flex-col w-full z-10">
              <h4 class="mt-1 text-white text-xl font-semibold leading-tight truncate">Loremipsum..</h4>
              <div class="flex justify-between items-center">
                <div class="flex flex-col">
          ...
          <div class="flex bg-white shadow-md rounded-2xl p-2">
            ...
            <div class="flex flex-col justify-center w-full px-2 py-1">
              <div class="flex justify-between items-center">
                ...
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  class="h-5 w-5 text-gray-500 hover:text-blue-400 cursor-pointer"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                >
