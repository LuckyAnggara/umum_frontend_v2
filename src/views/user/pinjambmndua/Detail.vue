    ...
    <div class="max-w-md mx-auto px-6 py-8 md:max-w-lg">
      ...
      <div class="flex items-center">
        <h2 class="ml-2 font-semibold text-gray-800 text-xl">
          Nomor Tiket : {{ peminjamanBmnStore.singleResponses.tiket }}
        </h2>
      </div>
      ...
      >
        ...
        <div class="flex flex-col divide-y divide-gray-200">
          <div
            v-for="(item, index) in peminjamanBmnStore.singleResponses?.detail"
            class="flex items-center py-4 px-6"
            :key="item.id"
          >
            <img
              class="w-24 h-24 object-cover rounded"
              :src="showImage(item.bmn)"
              alt="Product Image"
            />
            <div class="ml-5">
                  ...
                  >
                    ...
                    <div class="mt-2">
                      <p class="text-sm text-gray-500">
                        Permintaan bmn akan di proses ke Admin pada Bagian Umum
                    ...
                    <div class="mt-4 flex space-x-4">
                      <button
                        ...
                        @click="submit"
                      >
                        <span v-if="!peminjamanBmnStore.isStoreLoading">
                          Proses
                        </span>
