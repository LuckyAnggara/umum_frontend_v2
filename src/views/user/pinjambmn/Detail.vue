      ...
      >
        ...
        >
          <span v-if="!bmnStore.isLoading">
            <span class="font-medium">Oopss!</span> BMN tidak ditemukan, periksa
            kembali NUP dengan baik
          </span>
...
async function cariPegawai() {
  ...
  try {
    const response = await fetch(
      `https://lapkin.bbmakmur.com/api/employee-show/${peminjamanBmnStore.form.nip}`
    )
      .then((response) => {
        response
          .json()
