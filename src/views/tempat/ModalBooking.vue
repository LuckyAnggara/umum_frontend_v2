          ...
          >
            ...
            >
              ...
              <form
                ...
                class="mt-4 bg-white rounded-lg border border-gray-400 max-h-full overflow-visible text-left"
              >
                ...
                <div
                  class="px-4 py-4 border-b border-gray-200 flex flex-col space-y-4"
                >
                  <div class="text-left">
                    <label
                      for="name"
                  ...
                  <section>
                    <div
                      v-if="
                        tempatStore.items.length > 0 && tempatStore.form.tanggal
                      "
                    ...
                    >
                      <span class="font-medium"
                        ...
                        {{
                          moment(tempatStore.form.tanggal).format(
                            'DD MMMM YYYY'
                          )
                        }}</span
                      >
