            ...
            >
              ...
              <section v-else>
                <div class="w-full mx-auto px-6 text-left">
                  ...
                  >
                    <div
                      class="px-4 py-2 border-b border-gray-200 flex flex-row"
                    >
                      ...
                      >
                        <div>
                          ...
                          <div class="flex justify-center">
                            <img
                              ...
                              :src="
                                showImage(
                                  permintaanLayananBmnStore.singleResponses.bmn
                                    .image
                                )
                              "
                              alt="Product Image"
                        ...
                        <div>
                          ...
                          <input
                            readonly
                            v-model="
                              permintaanLayananBmnStore.singleResponses.bmn.nup
                            "
                            type="text"
                        ...
                        <div>
                          ...
                          <input
                            readonly
                            v-model="
                              permintaanLayananBmnStore.singleResponses.bmn.nama
                            "
                            type="text"
                            class="bg-gray-200 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                          />
                      ...
                      <div class="p-4 flex flex-col space-y-2">
                        <div class="text-left">
                          ...
                          <input
                            readonly
                            v-model="
                              permintaanLayananBmnStore.singleResponses
                                .jenis_layanan
                            "
                            type="text"
                            class="bg-gray-200 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        ...
                        <div
                          v-if="permintaanLayananBmnStore.singleResponses.nip"
                        >
                          <label
                            for="nip"
                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
                          ...
                          <input
                            v-model="
                              permintaanLayananBmnStore.singleResponses.nip
                            "
                            type="text"
                            id="nip"
                            class="bg-gray-200 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        ...
                        <div>
                          ...
                          <input
                            v-model="
                              permintaanLayananBmnStore.singleResponses.unit
                            "
                            type="text"
                            id="unit"
                            class="bg-gray-200 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        ...
                        <div class="text-left">
                          ...
                          <textarea
                            readonly
                            v-model="
                              permintaanLayananBmnStore.singleResponses.catatan
                            "
                            rows="3"
                      ...
                      <div class="text-left flex flex-col space-y-4">
                        <div>
                          ...
                          <input
                            readonly
                            :value="
                              permintaanLayananBmnStore.singleResponses.penerima
                            "
                            type="text"
                            id="nip"
                            class="bg-gray-200 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        ...
                        <div>
                          ...
                          <div class="border-2 rounded-xl p-2">
                            <vue-drawing-canvas
                              ...
                              :initial-image="
                                JSON.parse(
                                  permintaanLayananBmnStore.singleResponses.ttd
                                )
                              "
                              saveAs="png"
                            />
...
onUpdated(async () => {
  await permintaanLayananBmnStore.show(permintaanLayananBmnStore.tiketToShow)
})
</script>
