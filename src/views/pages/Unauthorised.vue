<template>
  <div class="flex flex-col items-center justify-center w-screen h-screen gap-12 py-8">
    <svg class="h-[50vh] aspect-video" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 500">
      ...
      <g id="freepik--security-barrier--inject-3">
        ...
        <rect
          ...
          width="271.93"
          height="26.36"
          style="fill: #3b82f6; stroke: #263238; stroke-miterlimit: 10; stroke-width: 1.166343341900884px"
        ></rect>
        <rect
          x="62.36"
          y="293.21"
        ...
        <line
          ...
          x2="324.91"
          y2="309.31"
          style="fill: none; stroke: #263238; stroke-miterlimit: 10; stroke-width: 1.166343341900884px"
        ></line>
        <line
          x1="61.21"
          y1="308.21"
    ...
    <div class="flex flex-col items-center gap-4">
      ...
      <p class="text-xl text-center">You tried to access a page you did not have prior authorization for.</p>
    </div>
  </div>
</template>
