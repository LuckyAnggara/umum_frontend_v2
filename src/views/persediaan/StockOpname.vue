    ...
    <Dialog as="div" @close="emit('close')" class="relative z-50">
      ...
      <div class="fixed inset-0 overflow-y-auto">
        ...
        >
          ...
          >
            <div
              class="relative p-4 bg-white w-1/3 rounded-lg shadow dark:bg-gray-800 sm:p-5"
            >
              <!-- Modal header -->
              <div
              ...
              <div class="flex flex-col space-y-4">
                ...
                <div class="flex flex-col space-y-4">
                  <div class="text-left">
                    ...
                    >
                    <input
                      v-model="mutasiPersediaanStore.form.jumlah"
                  ...
                  <div class="text-left">
                    ...
                    >
                    <select
                      v-model="mutasiPersediaanStore.form.tipe"
                  ...
                  <div class="text-left">
                    <label
                      for="brand"
                      class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
                      >Saldo setelah Stock Opname</label
                    >
                    <input
                      v-model="mutasiPersediaanStore.saldoAkhir"
                      readonly
                      placeholder="Saldo akhir setelah stock opname"
                      class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                    />
                  </div>
                  ...
                  <div class="text-left">
                    ...
                    >
                    <textarea
                      v-model="mutasiPersediaanStore.form.catatan"
                      rows="5"
                      placeholder="Isi keterangan atas pelaksanaan Stock Opname"
                      class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                    ></textarea>
                  </div>
                </div>
