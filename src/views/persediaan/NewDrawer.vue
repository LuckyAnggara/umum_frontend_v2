    ...
    <form>
      <div class="space-y-4">
        ...
        <div>
          ...
          >
          <input
            v-model="persediaanStore.form.nama"
            @keyup="search"
            type="text"
        ...
        <div>
          ...
          >
          <input
            v-model="persediaanStore.form.satuan"
            type="text"
            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
            required=""
        ...
        <div>
          ...
          >
          <input
            v-model="persediaanStore.form.saldo"
            type="number"
            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
            required=""
            placeholder="Saldo awal persediaan, kosongkan jika saldo 0"
          />
        </div>
      ...
      >
        ...
        >
          <span v-if="!persediaanStore.isStoreLoading"> Submit </span>
